...
namespace MyGUI
{
	...
	protected:
		...
		void notifyKeyButtonPressed(Widget* _sender, OIS::KeyCode _key, Char _char);
		void notifyKeyButtonReleased(Widget* _sender, OIS::KeyCode _key);
		...
		void notifyMouseDrag(Widget* _sender, int _left, int _top, OIS::MouseButtonID _id);
		void notifyMouseButtonPressed(Widget* _sender, int _left, int _top, OIS::MouseButtonID _id);
		void notifyMouseButtonReleased(Widget* _sender, int _left, int _top, OIS::MouseButtonID _id);
