...
namespace MyGUI
{
	...
	public:
		...
		MYGUI_OBSOLETE(" is deprecated, use : bool InputManager::injectMousePress(int _absx, int _absy, OIS::MouseButtonID _id)")
		bool injectMousePress(int _absx, int _absy, OIS::MouseButtonID _id);
		MYGUI_OBSOLETE(" is deprecated, use : bool InputManager::injectMouseRelease(int _absx, int _absy, OIS::MouseButtonID _id)")
	...
	{
	public:
		MYGUI_OBSOLETE(" is deprecated, use : const IntPoint& getLastPressedPosition(OIS::MouseButtonID _id) with _id OIS::MouseButtonID::Left")
		const IntPoint& getLastLeftPressed() const;
		MYGUI_OBSOLETE(" is deprecated, use : const IntPoint& getLastPressedPosition(OIS::MouseButtonID _id) with _id OIS::MouseButtonID::Right")
