...
enum Enum
{
	Info, // §ª§ß§æ§à§â§Þ§Ñ§è§Ú§à§ß§ß§à§Ö §ã§à§à§Ò§ë§Ö§ß§Ú§Ö.
	Warning, // §¯§Ö§ã§å§ë§Ö§ã§ä§Ó§Ö§ß§ß§Ñ§ñ §á§â§à§Ò§Ý§Ö§Þ§Ñ.
	Error, // §µ§ã§ä§â§Ñ§ß§Ú§Þ§Ñ§ñ §à§ê§Ú§Ò§Ü§Ñ.
	Critical, // §¯§Ö§å§ã§ä§â§Ñ§ß§Ú§Þ§Ñ§ñ §à§ê§Ú§Ò§Ü§Ñ §Ú§Ý§Ú §ã§Ò§à§Û §Ó §â§Ñ§Ò§à§ä§Ö §á§â§Ú§Ý§à§Ø§Ö§ß§Ú§ñ.
	MAX
};
...
#define MYGUI_LOGGING( level, text) \
{ \
	std::ostringstream oss; \
	oss<<text; \
	MyGUI::MyGUI_Logging( level, oss.str().c_str()); \
}

#define MYGUI_LOG_SECTION "Core"
#define MYGUI_LOG_FILENAME "MyGUI.log"
#define MYGUI_LOG(level, text) MYGUI_LOGGING( level, text)
