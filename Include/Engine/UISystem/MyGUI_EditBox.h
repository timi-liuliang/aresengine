...
namespace MyGUI
{
	...
	protected:
		...
		void notifyMousePressed(Widget* _sender, int _left, int _top, OIS::MouseButtonID _id);
		void notifyMouseReleased(Widget* _sender, int _left, int _top, OIS::MouseButtonID _id);
