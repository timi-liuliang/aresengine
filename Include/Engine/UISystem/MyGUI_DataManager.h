...
namespace MyGUI
{
	class MYGUI_EXPORT DataManager : public Ares::Singleton<DataManager>
	{
	public:
		// constructor
		DataManager();
		...
		*/
		IDataStream* getData(const std::string& _name);
		...
		*/
		//const VectorString& getDataListNames(const std::string& _pattern);
