...
namespace MyGUI
{
	...
	protected:
		...
		void onMouseDrag(int _left, int _top, OIS::MouseButtonID _id);
		void onMouseButtonPressed(int _left, int _top, OIS::MouseButtonID _id);
		void onMouseButtonReleased(int _left, int _top, OIS::MouseButtonID _id);

		void notifyMousePressed(MyGUI::Widget* _sender, int _left, int _top, OIS::MouseButtonID _id);
		void notifyMouseReleased(MyGUI::Widget* _sender, int _left, int _top, OIS::MouseButtonID _id);
		void notifyPressedButtonEvent(MyGUI::Widget* _sender);
		void notifyMouseDrag(MyGUI::Widget* _sender, int _left, int _top, OIS::MouseButtonID _id);
