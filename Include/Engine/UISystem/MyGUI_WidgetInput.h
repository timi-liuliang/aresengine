...
#include "Engine/InputSystem/OISKeyboard.h"
...
namespace MyGUI
{
	...
	*/
	...
	typedef delegates::CMultiDelegate4<Widget*, int, int, OIS::MouseButtonID> EventHandle_WidgetIntIntButton;
	typedef delegates::CMultiDelegate2<Widget*, OIS::KeyCode> EventHandle_WidgetKeyCode;
	typedef delegates::CMultiDelegate3<Widget*, OIS::KeyCode, Char> EventHandle_WidgetKeyCodeChar;
	...
	public:
		...
		*/
		...
		/** Event : Widget mouse move with captured widget.\n
			signature : void method(MyGUI::Widget* _sender, int _left, int _top, MyGUI::OIS::MouseButtonID _id)\n
			@param _sender widget that called this event
		...
		*/
		...
		void _riseMouseDrag(int _left, int _top, OIS::MouseButtonID _id);
		void _riseMouseMove(int _left, int _top);
		void _riseMouseWheel(int _rel);
		void _riseMouseButtonPressed(int _left, int _top, OIS::MouseButtonID _id);
		void _riseMouseButtonReleased(int _left, int _top, OIS::MouseButtonID _id);
		...
		void _riseKeyButtonPressed(OIS::KeyCode _key, Char _char);
		void _riseKeyButtonReleased(OIS::KeyCode _key);
	...
	protected:
		...
		virtual void onMouseDrag(int _left, int _top, OIS::MouseButtonID _id);
		virtual void onMouseMove(int _left, int _top);
		virtual void onMouseWheel(int _rel);
		virtual void onMouseButtonPressed(int _left, int _top, OIS::MouseButtonID _id);
		virtual void onMouseButtonReleased(int _left, int _top, OIS::MouseButtonID _id);
		virtual void onMouseButtonClick();
		virtual void onMouseButtonDoubleClick();
		virtual void onKeyLostFocus(Widget* _new);
		virtual void onKeySetFocus(Widget* _old);
		virtual void onKeyButtonPressed( OIS::KeyCode _key, Char _char);
		virtual void onKeyButtonReleased( OIS::KeyCode _key);
