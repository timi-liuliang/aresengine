...
namespace MyGUI
{
	...
	// 层级管理器
	//--------------------------------------------
	class MYGUI_EXPORT LayerManager : public Ares::Singleton<LayerManager>, public IUnlinkWidget, public MemberObsolete<LayerManager>
	{
	public:
	...
	private:
		bool			mIsInitialise;		// 是否已初始化
		VectorLayer		mLayerNodes;		// 层接点
	};
