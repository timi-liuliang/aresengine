...
#include "Engine/UISystem/MyGUI_Macros.h"
...
namespace MyGUI
{
	...
	void Window::onMouseDrag(int _left, int _top, OIS::MouseButtonID _id)
	{
	...
	void Window::onMouseButtonPressed(int _left, int _top, OIS::MouseButtonID _id)
	{
	...
	void Window::onMouseButtonReleased(int _left, int _top, OIS::MouseButtonID _id)
	{
	...
	void Window::notifyMousePressed(MyGUI::Widget* _sender, int _left, int _top, OIS::MouseButtonID _id)
	{
		if ( OIS::MB_Left == _id)
		{
	...
	void Window::notifyMouseDrag(MyGUI::Widget* _sender, int _left, int _top, OIS::MouseButtonID _id)
	{
		if (_id != OIS::MB_Left)
			return;

		const IntPoint& point = InputManager::GetSingleton().getLastPressedPosition( OIS::MB_Left);
	...
	void Window::updateAlpha()
	{
		...
		ControllerManager::GetSingleton().addItem(this, controller);
	}
	...
	void Window::animateStop(Widget* _widget)
	{
		if (mAnimateSmooth)
		{
			ControllerManager::GetSingleton().removeItem(this);
			mAnimateSmooth = false;
		}
	}
	...
	{
		ControllerItem* item = ControllerManager::GetSingleton().createItem(ControllerFadeAlpha::getClassTypeName());
	...
	void Window::notifyMouseReleased(MyGUI::Widget* _sender, int _left, int _top, OIS::MouseButtonID _id)
	{
		if ( OIS::MB_Left == _id)
		{
