...
#include "Engine/UISystem/MyGUI_WidgetInput.h"
...
namespace MyGUI
{
	...
	void WidgetInput::_riseMouseDrag(int _left, int _top, OIS::MouseButtonID _id)
	{
	...
	void WidgetInput::_riseMouseButtonPressed(int _left, int _top, OIS::MouseButtonID _id)
	{
		onMouseButtonPressed(_left, _top, _id);
		eventMouseButtonPressed(static_cast<Widget*>(this), _left, _top, _id);
	}

	void WidgetInput::_riseMouseButtonReleased(int _left, int _top, OIS::MouseButtonID _id)
	{
	...
	void WidgetInput::_riseKeyButtonPressed( OIS::KeyCode _key, Char _char)
	{
		onKeyButtonPressed(_key, _char);
		eventKeyButtonPressed(static_cast<Widget*>(this), _key, _char);
	}

	void WidgetInput::_riseKeyButtonReleased( OIS::KeyCode _key)
	{
	...
	void WidgetInput::onMouseDrag(int _left, int _top, OIS::MouseButtonID _id)
	{
	}
	...
	void WidgetInput::onMouseButtonPressed(int _left, int _top, OIS::MouseButtonID _id)
	{
	}

	void WidgetInput::onMouseButtonReleased(int _left, int _top, OIS::MouseButtonID _id)
	{
	}
	...
	void WidgetInput::onKeyButtonPressed( OIS::KeyCode _key, Char _char)
	{
	}

	void WidgetInput::onKeyButtonReleased( OIS::KeyCode _key)
	{
	}
