...
#include "Engine/UISystem/MyGUI_ResourceManualFont.h"
#include "Engine/UISystem/MyGUI_ResourceTrueTypeFont.h"
...
namespace MyGUI
{
	...
	void FontManager::initialise()
	{
		...
		ResourceManager::GetSingleton().registerLoadXmlDelegate(XML_TYPE) = newDelegate(this, &FontManager::_load);

		FactoryManager::GetSingleton().registerFactory<ResourceManualFont>(XML_TYPE_RESOURCE);
		FactoryManager::GetSingleton().registerFactory<ResourceTrueTypeFont>(XML_TYPE_RESOURCE);
	...
	void FontManager::shutdown()
	{
		...
		MyGUI::ResourceManager::GetSingleton().unregisterLoadXmlDelegate(XML_TYPE);

		FactoryManager::GetSingleton().unregisterFactory<ResourceManualFont>(XML_TYPE_RESOURCE);
		FactoryManager::GetSingleton().unregisterFactory<ResourceTrueTypeFont>(XML_TYPE_RESOURCE);
