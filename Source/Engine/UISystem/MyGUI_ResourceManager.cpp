...
#include "Engine/UISystem/MyGUI_IResource.h"
#include "Engine/UISystem/MyGUI_DataManager.h"
#include "Engine/UISystem/MyGUI_FactoryManager.h"

#include "Engine/UISystem/MyGUI_ResourceImageSet.h"

namespace Ares
{
	using namespace MyGUI;

	template <> ResourceManager* Ares::Singleton<ResourceManager>::m_singleton = nullptr;
...
namespace MyGUI
{
	...
	void ResourceManager::initialise()
	{
		...
		FactoryManager::GetSingleton().registerFactory<ResourceImageSet>(XML_TYPE);
	...
	void ResourceManager::shutdown()
	{
		...
		FactoryManager::GetSingleton().unregisterFactory<ResourceImageSet>(XML_TYPE);
	...
	{
		DataStreamHolder data = DataManager::GetSingleton().getData(_file);
