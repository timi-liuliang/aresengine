...
namespace Ares
{
	...
	template <> LanguageManager* Singleton<LanguageManager>::m_singleton = nullptr;
...
namespace MyGUI
{
	...
	void LanguageManager::initialise()
	{
		...
		ResourceManager::GetSingleton().registerLoadXmlDelegate(XML_TYPE) = newDelegate(this, &LanguageManager::_load);
