...
*/
#include "Engine/InputSystem/OISEffect.h"
	...
	axes(1)
{
	...
	switch( ef )
	{
	case ConstantForce:    effect = new_ ConstantEffect(); break;
	case RampForce:	       effect = new_ RampEffect(); break;
	case PeriodicForce:    effect = new_ PeriodicEffect(); break;
	case ConditionalForce: effect = new_ ConditionalEffect(); break;
	default: break;
	}
}
