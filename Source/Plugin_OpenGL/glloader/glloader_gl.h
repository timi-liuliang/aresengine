...
typedef void (GLLOADER_APIENTRY *glGetBooleanIndexedvEXTFUNC)(GLenum target, GLuint index, GLboolean* data);
typedef void (GLLOADER_APIENTRY *glGetIntegerIndexedvEXTFUNC)(GLenum target, GLuint index, GLint* data);
typedef void (GLLOADER_APIENTRY *glEnableIndexedEXTFUNC)(GLenum target, GLuint index);
typedef void (GLLOADER_APIENTRY *glDisableIndexedEXTFUNC)(GLenum target, GLuint index);
