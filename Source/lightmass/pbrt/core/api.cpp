...
// API Static Data
#define STATE_UNINITIALIZED  0		// 未初始化
#define STATE_OPTIONS_BLOCK  1		// Options 阻塞
#define STATE_WORLD_BLOCK    2		// 处理世界数据时阻塞
...
Camera *RenderOptions::MakeCamera() const 
{
    ...
    Camera *camera = ::MakeCamera(CameraName, CameraParams, CameraToWorld, renderOptions->transformStartTime, renderOptions->transformEndTime, film);
    if (!camera) 
