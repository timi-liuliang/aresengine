...
{
	// 构造函数
	QPbrtSyntaxHighLighter::QPbrtSyntaxHighLighter( QTextDocument* parent)
		: QSyntaxHighlighter( parent)
	{
		...
		keywordPatterns << "\\bFilm\\b"  << "\\bLookAt\\b"  << "\\bCamera\\b"  << "\\bWorldBegin\\b"  << "\\bAttributeBegin\\b"
						<< "\\bAttributeEnd\\b"  << "\\bShape\\b"  << "\\bMaterial\\b"  << "\\bWorldEnd\\b"  << "\\bhalf4\\b"
	...
	// 高度block
	void  QPbrtSyntaxHighLighter::highlightBlock( const QString& text)
	{
